...
class CareerPartnerPagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Career partnerPagination';
    ...
    protected static $openAPITypes = [
        ...
        'has_next' => 'bool',
        'next_num' => 'int',
        'data' => '\OpenAPI\Client\Model\CareerPartner[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\CareerPartner[]|null
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\CareerPartner[]|null $data data
     *
     * @return self
     */
