...
/**
 * EditorJSLinkResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EditorJSLinkResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EditorJSLinkResponse';
    ...
    protected static $openAPITypes = [
        'success' => 'bool',
        'items' => '\OpenAPI\Client\Model\EditorJSLink[]'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \OpenAPI\Client\Model\EditorJSLink[]|null
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\EditorJSLink[]|null $items items
     *
     * @return self
     */
