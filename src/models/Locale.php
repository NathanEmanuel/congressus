    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Locale., must be smaller than or equal to 255.');
        }
    ...
    public function setCode($code)
    {
        ...
        if (!is_null($code) && (mb_strlen($code) > 32)) {
            throw new \InvalidArgumentException('invalid length for $code when calling Locale., must be smaller than or equal to 32.');
        }
