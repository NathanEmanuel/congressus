...
/**
 * CollectionMembership Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CollectionMembership implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CollectionMembership';
    ...
    */
    ...
    public function setFunction($function)
    {
        ...
        if (!is_null($function) && (mb_strlen($function) > 255)) {
            throw new \InvalidArgumentException('invalid length for $function when calling CollectionMembership., must be smaller than or equal to 255.');
        }
