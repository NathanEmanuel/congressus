...
class GroupMembershipPagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Group membershipPagination';
    ...
    protected static $openAPITypes = [
        ...
        'has_next' => 'bool',
        'next_num' => 'int',
        'data' => '\OpenAPI\Client\Model\GroupMembership[]'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\GroupMembership[]|null $data data
     *
     * @return self
     */
