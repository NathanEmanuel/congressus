...
class BlogCategoryPagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Blog categoryPagination';
    ...
    protected static $openAPITypes = [
        ...
        'has_next' => 'bool',
        'next_num' => 'int',
        'data' => '\OpenAPI\Client\Model\BlogCategory[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\BlogCategory[]|null
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\BlogCategory[]|null $data data
     *
     * @return self
     */
