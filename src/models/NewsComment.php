 ...
 */
class NewsComment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NewsComment';
    ...
    */
     ...
     * Sets news_id
     *
     * @param int|null $news_id news_id
     *
     * @return self
     */
    ...
    {
        if (is_null($news_id)) {
            throw new \InvalidArgumentException('non-nullable news_id cannot be null');
        }
