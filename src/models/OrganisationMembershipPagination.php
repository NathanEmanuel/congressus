...
class OrganisationMembershipPagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Organisation membershipPagination';
    ...
    protected static $openAPITypes = [
        ...
        'has_next' => 'bool',
        'next_num' => 'int',
        'data' => '\OpenAPI\Client\Model\OrganisationMembership[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\OrganisationMembership[]|null
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\OrganisationMembership[]|null $data data
     *
     * @return self
     */
