 ...
 */
class VatCategory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VatCategory';
    ...
    */
     ...
     * Sets percentage
     *
     * @param mixed|null $percentage percentage
     *
     * @return self
     */
