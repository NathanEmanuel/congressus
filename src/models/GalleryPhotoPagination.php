...
class GalleryPhotoPagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Gallery photoPagination';
    ...
    protected static $openAPITypes = [
        ...
        'has_next' => 'bool',
        'next_num' => 'int',
        'data' => '\OpenAPI\Client\Model\GalleryPhoto[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\GalleryPhoto[]|null
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\GalleryPhoto[]|null $data data
     *
     * @return self
     */
