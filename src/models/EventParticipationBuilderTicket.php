...
/**
 * EventParticipationBuilderTicket Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EventParticipationBuilderTicket implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EventParticipationBuilderTicket';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling EventParticipationBuilderTicket., must be smaller than or equal to 255.');
        }
     ...
     * Sets ticket_type_id
     *
     * @param int|null $ticket_type_id ticket_type_id
     *
     * @return self
     */
