...
class EventCategoryPagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Event categoryPagination';
    ...
    protected static $openAPITypes = [
        ...
        'has_next' => 'bool',
        'next_num' => 'int',
        'data' => '\OpenAPI\Client\Model\EventCategory[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\EventCategory[]|null
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\EventCategory[]|null $data data
     *
     * @return self
     */
