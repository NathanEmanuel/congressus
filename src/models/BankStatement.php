...
class BankStatement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'bank_import' => '\OpenAPI\Client\Model\BankImport',
        'statement_id' => 'string',
        'iban' => 'string',
        'begin' => '\DateTime',
        'end' => '\DateTime'
    ...
    */
     ...
     * Gets bank_import
     *
     * @return \OpenAPI\Client\Model\BankImport|null
     */
     ...
     * Sets bank_import
     *
     * @param \OpenAPI\Client\Model\BankImport|null $bank_import bank_import
     *
     * @return self
     */
