...
class GroupWithMemberships implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'folder_id' => 'int',
        'folder' => '\OpenAPI\Client\Model\GroupFolder',
        'name' => 'string',
        ...
        'end' => '\DateTime',
        'memo' => 'string',
        'memberships' => '\OpenAPI\Client\Model\CollectionMembership[]'
    ];
    ...
    */
     ...
     * Gets folder
     *
     * @return \OpenAPI\Client\Model\GroupFolder|null
     */
     ...
     * Sets folder
     *
     * @param \OpenAPI\Client\Model\GroupFolder|null $folder folder
     *
     * @return self
     */
     ...
     * Gets memberships
     *
     * @return \OpenAPI\Client\Model\CollectionMembership[]|null
     */
     ...
     * Sets memberships
     *
     * @param \OpenAPI\Client\Model\CollectionMembership[]|null $memberships memberships
     *
     * @return self
     */
