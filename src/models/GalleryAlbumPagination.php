...
class GalleryAlbumPagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Gallery albumPagination';
    ...
    protected static $openAPITypes = [
        ...
        'has_next' => 'bool',
        'next_num' => 'int',
        'data' => '\OpenAPI\Client\Model\GalleryAlbum[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\GalleryAlbum[]|null
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\GalleryAlbum[]|null $data data
     *
     * @return self
     */
