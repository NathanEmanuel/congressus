...
class BankMutationPagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'bank mutationPagination';
    ...
    protected static $openAPITypes = [
        ...
        'has_next' => 'bool',
        'next_num' => 'int',
        'data' => '\OpenAPI\Client\Model\BankMutation[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\BankMutation[]|null
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\BankMutation[]|null $data data
     *
     * @return self
     */
