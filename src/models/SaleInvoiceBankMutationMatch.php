...
/**
 * SaleInvoiceBankMutationMatch Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SaleInvoiceBankMutationMatch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SaleInvoiceBankMutationMatch';
    ...
    */
     ...
     * Sets amount
     *
     * @param float|null $amount Amount to match. When empty, the unpaid amount for the sale invoice is used.
     *
     * @return self
     */
