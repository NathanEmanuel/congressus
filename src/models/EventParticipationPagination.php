...
class EventParticipationPagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Event participationPagination';
    ...
    protected static $openAPITypes = [
        ...
        'has_next' => 'bool',
        'next_num' => 'int',
        'data' => '\OpenAPI\Client\Model\EventParticipation[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\EventParticipation[]|null
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\EventParticipation[]|null $data data
     *
     * @return self
     */
