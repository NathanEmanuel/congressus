 ...
 */
class BankImport implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BankImport';
    ...
    public const STATUS_NOT_COMPLETED = 'not completed';
    ...
    */
     ...
     * Sets status
     *
     * @param string|null $status Match status for all mutations within this import
     *
     * @return self
     */
