 ...
 */
class SavedReply implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SavedReply';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('message_json', $data ?? [], null);
    }
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling SavedReply., must be smaller than or equal to 255.');
        }
    ...
    public function setSubject($subject)
    {
        ...
        if (!is_null($subject) && (mb_strlen($subject) > 255)) {
            throw new \InvalidArgumentException('invalid length for $subject when calling SavedReply., must be smaller than or equal to 255.');
        }
    ...
    {
        return $this->container['message_json'];
    }

    /**
     * Sets message_json
     *
     * @param mixed|null $message_json message_json
     *
     * @return self
     */
    public function setMessageJson($message_json)
    {
        if (is_null($message_json)) {
            array_push($this->openAPINullablesSetToNull, 'message_json');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('message_json', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['message_json'] = $message_json;
