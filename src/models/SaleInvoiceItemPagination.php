...
class SaleInvoiceItemPagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'sale invoice itemPagination';
    ...
    protected static $openAPITypes = [
        ...
        'has_next' => 'bool',
        'next_num' => 'int',
        'data' => '\OpenAPI\Client\Model\SaleInvoiceItem[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\SaleInvoiceItem[]|null
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\SaleInvoiceItem[]|null $data data
     *
     * @return self
     */
