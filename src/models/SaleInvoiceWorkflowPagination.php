...
class SaleInvoiceWorkflowPagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'sale invoice workflowPagination';
    ...
    protected static $openAPITypes = [
        ...
        'has_next' => 'bool',
        'next_num' => 'int',
        'data' => '\OpenAPI\Client\Model\SaleInvoiceWorkflow[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\SaleInvoiceWorkflow[]|null
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\SaleInvoiceWorkflow[]|null $data data
     *
     * @return self
     */
