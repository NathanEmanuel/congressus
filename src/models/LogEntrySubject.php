...
/**
 * LogEntrySubject Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class LogEntrySubject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LogEntrySubject';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('absolute_url', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets absolute_url
     *
     * @param mixed|null $absolute_url absolute_url
     *
     * @return self
     */
    public function setAbsoluteUrl($absolute_url)
    {
        if (is_null($absolute_url)) {
            array_push($this->openAPINullablesSetToNull, 'absolute_url');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('absolute_url', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
